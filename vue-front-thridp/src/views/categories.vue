        ...
        <div class="entry-content">
          ...
          <div class="poem-wrap">
            ...
            <!--红桶凉席今犹在，我辈岂是打工人
                胸中有千言,下笔无一字
            -->
            <p id="poem">别看你今天闹得欢,小心今后拉清单,这都得应验的。
              不要干这种事情，头上三尺有神明，啊 一定要有敬畏之心</p>
            <p id="info">小熊维尼</p></div>
...
.good{
  ...
  top:0;
  border-style: solid;
  border-width: 0px 50px 40px 0px;
  border-color: transparent #ff0033 transparent transparent !important;
  width: 0px;
  height: 0px;
}
.good span{
